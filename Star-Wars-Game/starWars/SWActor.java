...
public abstract class SWActor extends Actor<SWActionInterface> implements SWEntityInterface {
	...
	private ArrayList<SWActor> followers = new ArrayList<SWActor>();

	private Boolean isFollowing = false;
	
	private Droids OwningWhichdroid;
	
	private Boolean hasDroid = false;
	//------------------------------ CHANGES MADE END HERE------------------------------------------------
	...
	//------------------------------ CHANGES MADE START HERE------------------------------------------------
	public void setForceAbility(int force){
		
		if (force > 100){
			this.forceAbility = 100;
		}
		
		else{
			this.forceAbility = force;
		}
		
	}
	
	
	public void addFollowers(SWActor a){
		this.followers.add(a);
	}
	
	public void removeFollowers(SWActor a){
	...
	public void setHitpoints(int hitpoints){
		...
		if (this.hitpoints < 0){
			this.hitpoints=0;
			if (this instanceof Droids){
				((Droids)this).setisImmobile(true);
			}
		}
	...
	public void sethasMind(Boolean val){
	...
	public void setDroid(Droids droid){
		...
		this.OwningWhichdroid = droid;
	}
	
	public Droids getDroid(){
		return this.OwningWhichdroid;
	}

	public void sethasDroid(Boolean val){
	
		this.hasDroid = val;
	}
	
	public Boolean gethasDroid(){
		
		return this.hasDroid;
	}
	
	public Boolean gethasMind(){
		
		return this.hasMind;
	}
	
	public ArrayList clonefollowers(){
		ArrayList<SWActor> cloneFollowers = new ArrayList<SWActor>();
		
		int i = 0;
		
		while (i < this.followers.size()){
			cloneFollowers.add(this.followers.get(i));
			i = i + 1;
		}
		
		return cloneFollowers;
	}
   ...
   public Boolean getIsFollowing(){
	...
	public void setIsFollowing(Boolean val){
	...
	public void setItemCarried(SWEntityInterface target) {
		...
		if (target instanceof LightSaber && this.getForceAbility() == 100) {
			((LightSaber) target).addWeaponCapability();
		}
