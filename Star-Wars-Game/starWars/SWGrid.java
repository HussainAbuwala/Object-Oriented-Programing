...
public class SWGrid extends Grid<SWLocation> {
	 ...
	 * Will create a grid based on the x and y coordinates.
	 * 
	 * @param factory the maker of the <code>SWLocation</code>s
	 */
	
	private Boolean IsLukeHere = false;
	public SWGrid(int x, int y,LocationMaker<SWLocation> factory) {
		super(x,y,factory);
	}
	
	/**This method sets a boolean if luke is here in the grid.*/

	
	public void setIsLukeHere(Boolean val){
		this.IsLukeHere = val;
	}
	
	/**This method returns boolean IsLukeHere.*/

	
	public Boolean getIsLukeHere(){
		return this.IsLukeHere;
	}
